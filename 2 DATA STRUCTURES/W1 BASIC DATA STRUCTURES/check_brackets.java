...
// Good job! (Max time used: 0.09/1.50, max memory used: 31305728/2147483648.)
class Bracket {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (int position = 0; position < text.length(); ++position) {
            ...
            if (next == ')' || next == ']' || next == '}') {
                ...
                Bracket lastBracket = openingBracketsStack.pop();
        ...
        if(openingBracketsStack.isEmpty())
            ...
            System.out.println(openingBracketsStack.firstElement().position+1);
    }
}
